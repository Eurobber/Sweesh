...
?>
    ...
    <div class="container">
        <div class="col-lg-8 col-lg-offset-2 well top-buffer-plus isRound bloc">
            <div class="col-lg-10">
                ...
                <?php echo $this->Form->create('User', array('class' => 'form-horizontal', 'inputDefaults' => array('label' => false))); ?>
                    <div class="form-group">
                        <label for="username" class="col-sm-3 control-label"><span class="pull-left">Identifiant</label>
                <div class="col-sm-9">
            ...
            <div class="form-group">
                <div class="col-sm-4">
                        <small> <?php echo $this->Html->link('Mot de passe oublié?', array('controller' => 'users', 'action' => 'forgot_password')); ?></small>
                    </div>
                </div>
