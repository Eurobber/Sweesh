                ...
                <h1 class="page-header">Rejoindre la communauté <span style="color:#00aaff;">s</span><span style="color:#aaa;">W</span><span style="color:#ff4433;">eesh</span></h1> 
                    <?php echo $this->Form->create('User',array('class'=>'form-horizontal','inputDefaults'=>array('label'=>false)));?> 
                          <div class="form-group"> 
                            ...
                            <label for="password" class="col-sm-2 col-sm-offset-1 control-label"><span class="pull-left">Mot de passe</label> 
                            <div class="col-sm-4"> 
                          ...
                          <div class="form-group"> 
                            ...
                            <label for="street" class="col-sm-2 col-sm-offset-1 control-label"><span class="pull-left">Adresse</label> 
                            <div class="col-sm-4"> 
                          ...
                          <div class="form-group"> 
                            ...
                            <label for="zipcode" class="col-sm-2 col-sm-offset-1 control-label"><span class="pull-left">Code postal</label> 
                            <div class="col-sm-4"> 
