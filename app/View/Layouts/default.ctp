                                        ...
                                        <div class="header-nav-main header-nav-main-effect-1 header-nav-main-sub-effect-1 collapse">
                                            <nav>
                                                <ul class="nav nav-pills nav-main" id="mainNav">
                                                    ...
                                                    echo $this->Html->link('Mes weeshlists', array('controller' => 'weesh_lists', 'action' => 'index'), array('class' => 'purple'));
                                                endif; ?>
                                                    </li>
                                                    <li>
                                                        <?php if (AuthComponent::user()):
            ...
            <footer>
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <h4>Nous sommes sur @Twitter</h4> <a class="twitter-timeline" data-lang="fr" data-width="320" data-height="200" data-theme="light" href="https://twitter.com/Weesh_io">Tweets by Weesh_io</a>
                            <script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script>
                        </div>
                        <div class="col-md-4">
                            <h4>Inscrivez-vous à la newsletter</h4>
                            <p>Renseignez votre adresse e-mail et nous vous tiendrons au courant des nouvelles fonctionnalités supportées, des nouveaux sites parcourus et des évolutions prévues.</p>
                        ...
                        'inputDefaults' => array('label' => false))); ?>
                                ...
                                <?php echo $this->Form->end(); ?>
                                    ...
                                    <p style="margin-top:15px;">Cliquez sur "Contact" (en bas de la page) pour nous suggérer un nouveau site à supporter.</p>
                        ...
                        <div class="col-md-4">
                            <div class="contact-details">
                                ...
                                <p style="margin:0;">
                                    </i> <strong>E-mail : </strong>weesh.io.contact@gmail.com</p>
                            </div>
                            ...
                            <div class="col-md-11 row social-btns">
                                <ul class="social-icons list-inline">
                                    ...
                                    <li> <a class="btn twitter" href="https://twitter.com/weesh_io"><i class="fa fa-twitter"></i></a> </li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        -->
                ...
                <?php echo $this->fetch('script'); ?>
                    <?php /** DEBUG
     * echo $this->element('sql_dump'); ?> **/ ?> </body>
