...
?>
    ...
    <div class="container">
        <div class="col-lg-10 col-lg-offset-1 well top-buffer-plus bloc">
                    ...
                    <div class="col-md-12">
                        <ul class="portfolio-list">
                            <div class="row">
                                <li class="col-md-2 col-sm-4 col-xs-12">
                                    <div class="portfolio-item">
                                        <a href="https://www.amazon.fr/" target="_blank"> <span class="thumb-info thumb-info-lighten">
                                ...
                                <li class="col-md-2 col-sm-4 col-xs-12">
                                    <div class="portfolio-item">
                                        <a href="http://www.castorama.fr/store/" target="_blank"> <span class="thumb-info thumb-info-lighten">
                                        <span class="thumb-info-wrapper">
                                ...
                                <li class="col-md-2 col-sm-4 col-xs-12">
                                    <div class="portfolio-item">
                                        <a href="http://www.cdiscount.com/" target="_blank"> <span class="thumb-info thumb-info-lighten">
                                        <span class="thumb-info-wrapper">
                                ...
                                <li class="col-md-2 col-sm-4 col-xs-12">
                                    <div class="portfolio-item">
                                        <a href="http://www.darty.com/" target="_blank"> <span class="thumb-info thumb-info-lighten">
                                        <span class="thumb-info-wrapper">
                                ...
                                <li class="col-md-2 col-sm-4 col-xs-12">
                                    <div class="portfolio-item">
                                        <a href="http://www.fnac.com/" target="_blank"> <span class="thumb-info thumb-info-lighten">
                                        <span class="thumb-info-wrapper">
                                ...
                                <li class="col-md-2 col-sm-4 col-xs-12">
                                    <div class="portfolio-item">
                                        <a href="https://www.grosbill.com/" target="_blank"> <span class="thumb-info thumb-info-lighten">
                                        <span class="thumb-info-wrapper">
                            ...
                            <div class="row">
                                <li class="col-md-2 col-sm-4 col-xs-12">
                                    <div class="portfolio-item">
                                        <a href="http://www.laredoute.fr/" target="_blank"> <span class="thumb-info thumb-info-lighten">
                                        <span class="thumb-info-wrapper">
                                ...
                                <li class="col-md-2 col-sm-4 col-xs-12">
                                    <div class="portfolio-item">
                                        <a href="http://www.ldlc.com/" target="_blank"> <span class="thumb-info thumb-info-lighten">
                                        <span class="thumb-info-wrapper">
                                ...
                                <li class="col-md-2 col-sm-4 col-xs-12">
                                    <div class="portfolio-item">
                                        <a href="http://www.priceminister.com/" target="_blank"> <span class="thumb-info thumb-info-lighten">
                                        <span class="thumb-info-wrapper">
                                ...
                                <li class="col-md-2 col-sm-4 col-xs-12">
                                    <div class="portfolio-item">
                                        <a href="http://www.rueducommerce.fr/home/index.htm" target="_blank"> <span class="thumb-info thumb-info-lighten">
                                        <span class="thumb-info-wrapper">
                                ...
                                <li class="col-md-2 col-sm-4 col-xs-12">
                                    <div class="portfolio-item">
                                        <a href="http://www.tesco.com/" target="_blank"> <span class="thumb-info thumb-info-lighten">
                                        <span class="thumb-info-wrapper">
                                ...
                                <li class="col-md-2 col-sm-4 col-xs-12">
                                    <div class="portfolio-item">
                                        <a href="http://www.ubaldi.com/accueil/" target="_blank"> <span class="thumb-info thumb-info-lighten">
                                        <span class="thumb-info-wrapper">
            ...
            <div class="col-lg-10 col-lg-offset-1">
                ...
                <?php echo $this->Form->create('Contact', array('action' => 'index', 'class' => 'form-horizontal', 'inputDefaults' => array('label' => false))); ?>
                    <div class="form-group">
                        <label for="username" class="col-sm-3 control-label"><span class="pull-left">Site à ajouter<span style="color:red;">*</span></label>
                        <div class="col-sm-9">
                            <?php echo $this->Form->input('site_name', array('class' => 'form-control')); ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="username" class="col-sm-3 control-label"><span class="pull-left">URL du site</label>
                <div class="col-sm-9">
