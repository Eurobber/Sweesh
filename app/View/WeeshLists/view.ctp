            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-5" style=" margin-top:3%;">
                        <form class="btn btn-lg btn-primary btn-orange" data-toggle="modal" data-target="#<?php echo 'modalComparator'.$i?>">Autres fournisseurs</form>
                    </div>
                        ...
                        <?php echo $this->Form->create('Item', array('action' => 'removeFromWeeshlist')); ?>
                            <?php echo $this->Form->input('item_id', array('type' => 'hidden', 'value' => $value['id'])); ?>
                                <?php echo $this->Form->input('weesh_list_id', array('type' => 'hidden', 'value' => $current_weeshlist_id)); ?>
                                    <?php echo $this->Form->submit('Enlever ce produit de la weeshlist', array('class' => 'btn btn-lg btn-primary btn-orange')); ?>
                                        <?php echo $this->Form->end(); ?>
                    </div>
                </div>
            </div>
